...
- Changes to SqlServerDsc
  ...
  - [Glenn Sarti (@glennsarti)](https://github.com/glennsarti): Renamed SqlServerDsc.psd1 to be
    consistent ([issue #1116](https://github.com/PowerShell/SqlServerDsc/issues/1116)).
