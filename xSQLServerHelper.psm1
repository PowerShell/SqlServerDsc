...
<#
    .SYNOPSIS
        Return $true is the login (user) is a member in the provided server role.
        If the user it not member of the provided server role then $false will be returned.
